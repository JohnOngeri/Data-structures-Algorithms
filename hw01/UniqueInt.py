...
if __name__ == "__main__":
    ...
    input_file_path = "Data-structures-Algorithms/hw01/sample_inputs/sample_input_01.txt"
    output_file_path = "Data-structures-Algorithms/hw01/sample_results/sample_input_01.txt_results.txt"
